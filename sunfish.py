...
pst = {
    ...
    'Q': (   6,   1,  -8,-104,  69,  24,  88,  26,
           ...
           -14, -15,  -24,  -5,  -1, -10, -20, -22,
           -30,  -6, -13, -11, -16, -11, -16, -27,
           -36, -18,   0, -19, -15, -15, -21, -38,
           -39, -30, -31, -13, -31, -36, -34, -42),
    'K': (   54,  54,  47, -99, -99,  60,  83, -62,
           -32,  10,  55,  56,  56,  55,  10,   3,
           -62,  12, -57,  44, -67,  28,  37, -31,
           -55,  50,  4,  -4, -19,  13,   0, -49,
...
def main(given_move):
    ...
    while True:
        ...
        match = re.match('([a-h][1-8])'*2, given_move)
        move = parse(match.group(1)), parse(match.group(2))
        pos = pos.move(move)
        ...
        move, score = searcher.search(pos, secs=0.00095)
